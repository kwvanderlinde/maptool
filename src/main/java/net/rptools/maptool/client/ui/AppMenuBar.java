...
public class AppMenuBar extends JMenuBar {
  ...
  protected JMenu createViewMenu() {
    ...
    JCheckBoxMenuItem toggleLumensOverlay = new RPCheckBoxMenuItem(AppActions.TOGGLE_LUMENS_OVERLAY, menu);
    toggleLumensOverlay.setSelected(AppState.isShowLumensOverlay());
    menu.add(toggleLumensOverlay);

    JCheckBoxMenuItem toggleShowLights = new RPCheckBoxMenuItem(AppActions.TOGGLE_SHOW_LIGHTS, menu);
