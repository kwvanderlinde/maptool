...
public class RenderHelper {
  // TODO I prefer not to take a dependence on the zone renderer as a concept.
  ...
  private void doRender(Graphics2D g, Consumer<Graphics2D> render) {
    ...
    // TODO If `g` already has a clip, how do we incorporate it here?
    g.setClip(new Area(new Rectangle(0, 0, size.width, size.height)));
    SwingUtil.useAntiAliasing(g);

    // TODO If `g` already has a transform, how do we incorporate it here? Do we need to?
