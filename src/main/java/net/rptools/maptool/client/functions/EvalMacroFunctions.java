...
public class EvalMacroFunctions extends AbstractFunction {
  ...
  public Object childEvaluate(
    ...
    MapToolVariableResolver mtResolver = (MapToolVariableResolver) resolver;

    if (!lineParser.isMacroTrusted()) {
      throw new ParserException(I18N.getText("macro.function.general.noPerm", functionName));
    }

    Token tokenInContext = mtResolver.getTokenInContext();
  ...
  public static Object evalMacro(MapToolVariableResolver res, String line) throws ParserException {
