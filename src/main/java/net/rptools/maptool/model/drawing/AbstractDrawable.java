 ...
 */
public abstract class AbstractDrawable implements Drawable, ImageObserver {
  /**
  ...
  protected AbstractDrawable(GUID id) {
    this.id = id;
  }

  protected AbstractDrawable(AbstractDrawable other) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof AbstractDrawable)) return false;
