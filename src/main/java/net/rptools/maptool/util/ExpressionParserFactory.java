...
public class ExpressionParserFactory {
  public ExpressionParser create() {
    return new ExpressionParser(
        ExpressionParserFactory::getVariable,
        ExpressionParserFactory::getProperty,
        ExpressionParserFactory::getPromptedValue);
  }
   ...
   */
  private static Object getVariable(VariableResolver resolver, String name) {
   ...
   */
  private static Object getProperty(VariableResolver resolver, String name) {
   ...
   * @return the value.
   */
  private static String getPromptedValue(String name) {
    var option =
