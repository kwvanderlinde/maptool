...
public class ServerHandshake2 implements Handshake2, MessageHandler {
  ...
  private final List<Handshake2.Observer> observerList = new CopyOnWriteArrayList<>();
  ...
  /**
   * Creates a new {@link ServerHandshake2} instance.
   *
    ...
    try {
      ...
      switch (currentState) {
        ...
        case AwaitingClientPublicKeyAuth:
          if (msgType == HandshakeMsg.MessageTypeCase.CLIENT_AUTH_MESSAGE) {
        ...
        case AwaitingPublicKey:
          if (msgType == HandshakeMsg.MessageTypeCase.PUBLIC_KEY_UPLOAD_MSG) {
   ...
   */
  public synchronized void addObserver(Handshake2.Observer observer) {
   ...
   * @param observer the observer of the handshake process.
   */
  public synchronized void removeObserver(Handshake2.Observer observer) {
